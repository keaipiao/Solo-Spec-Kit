...
本轮验证更新后的 `/solo` 主 Skill 在只安装主 Skill、未安装任何专家 sibling 的情况下，仍能保留基础流程，并明确表达专家模块是“可建议、需确认、可降级”的增强能力。
...
真实独立子代理盲测已完成，见 `docs/23-blind-forward-expert-suggestion-test.md`。
