...
- Product expert normally has no assets; use `machine.assets: []` unless the input includes a concrete reference artifact that the main workflow should register elsewhere.
